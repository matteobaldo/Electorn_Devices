...
\end{equation}
Moving $E_f$ upwards some hypothesis falls (we supposed $E_f$ to be under $E_d$) : when $E_f$ reachs $E_d$ the complete ionization theory is not true anymore and from there further the M-B approximation is no longer valid.\\
\newline
%------------------------------------------------------------------------%
